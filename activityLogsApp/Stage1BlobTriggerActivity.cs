...
namespace NwNsgProject
{
    public static class Stage1BlobTriggerActivity
    {
        ...
        public static async Task Run(
            [BlobTrigger("%blobContainerNameActivity%/name=AvidActivityLogCollector/resourceId=/SUBSCRIPTIONS/{subId}/y={blobYear}/m={blobMonth}/d={blobDay}/h={blobHour}/m={blobMinute}/PT1H.json", Connection = "nsgSourceDataConnection")]CloudAppendBlob myBlobActivity,
